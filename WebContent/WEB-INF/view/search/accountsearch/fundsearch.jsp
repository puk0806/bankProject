...
<script src="https://simg.wooribank.com/js/com/jquery-1.7.1.min.js?1363353990000" charset='euc-kr'></script>
<script src="https://simg.wooribank.com/js/com/jquery-ui-1.8.24.custom.min.js?1363353990000" charset='euc-kr'></script>
<script src="https://simg.wooribank.com/js/com/jquery.bgpos.min.js?1363353990000" charset='euc-kr'></script>
<script src="https://simg.wooribank.com/js/com/wbui.min-20130514-2.js?1557995377000" charset='euc-kr'></script>
<script src="https://simg.wooribank.com/js/com/calendar.js?1365500133000" charset='euc-kr'></script>
<script src="https://simg.wooribank.com/js/com/ui_frm_common.js?1364556535000" charset='euc-kr'></script>
<script src="https://simg.wooribank.com/js/com/common.js?1525668543000" charset='euc-kr'></script>
<script src="https://simg.wooribank.com/js/pib/bx/jquery.bxslider.min.js?1480530151000" charset='euc-kr'></script>
<script src="https://simg.wooribank.com/js/main.js?1525571209000" charset='euc-kr'></script>
...
<div class="tab1 new js-tab ui-set-tab1 ui-set-tab">
	<ul style="height: 41px;">
		...
		<li class="on" id="li_tabFund" style="width: 134px; height: 39px;"> <a href="/bankJSPProject/search/accountsearch/fundsearch.do" class="js-tab-header font-14 ui-tab-selector" data-pre-handler="str_GetAcctInq(4)" style="font-size: 13px; line-height: 16px; padding-top: 8px; padding-bottom: 8px;">펀드</a></li>
...
<div id="tabDep_sub_top3" class="title-area clearfix mt30 data-hidden">	<h3 class="title-block">적금</h3><div class="title-data"><span class="down" id="totDep3">총잔액 : <strong>0원</strong></span><span class="btn-open printnoa"><a class="js-display-toggle ui-set-display-toggle on" onclick="onDepOpenSet('tabDep_sub3');" data-target="#tabDep_sub3" href="#tabDep_sub3">적금 닫기</a></span><dl class="info-txt"><dt>최근접속일시 :</dt><dd class="f">2020.01.03&nbsp;16:08:00</dd><dt class="ml10">조회기준일시 :</dt><dd class="f">2020.01.03 18:16:25</dd></dl></div></div><div id="tabDep_sub3" class="w950"><table id="tabDep_sub_table3" data-auto-summary="false" class="tbl-type-1 ui-set-tbl-type" border="1" cellspacing="0" summary="예금명, 계좌번호, 최종거래일, 잔액(원), 바로가기 제공"><caption>적금계좌목록</caption><colgroup><col width="22%"><col><col width="17%"><col width="18%"><col width="24%"></colgroup><thead><tr><th scope="col">예금명</th><th scope="col">계좌번호</th><th scope="col">최종거래일</th><th scope="col">잔액(원)</th><th scope="col">바로가기</th></tr></thead><tbody><tr><td class="nodata" colspan="5">보유중인 상품이 없습니다.<br><span class="ml120">매달 차곡차곡 쌓이는 재미, 적금 가입하고 소소한 재미를 즐겨보세요.</span>	<span class="ml60 btn-pack btn-type-2 ui-set-btn-pack"><a class="" href="/pib/Dream?withyou=PODEP0001&amp;TAB_GBN=2" ');"="">가입하기</a></span></td></tr></tbody></table></div>
		...
		<div class="btn-area mt20 hidden" id="divDepBtnCtrl">  
			...
			<span class=" btn-pack btn-type-3 ui-btn-pack-a ui-set-btn-pack ui-set-btn-pack-event"><a class="" href="/pib/jcc?withyou=PSINQ0013&amp;__ID=c004102&amp;fInqCd=4&amp;XSL_FILE_NAME=우리은행_펀드_보유계좌조회_20200103" id="divExcelLink_dep">엑셀저장</a></span>
...
<div id="tabFund" class="dis-n" style="display: block;">
	...
	<div id="PRINT_BLOCK4"> 
		...
		<div class="title-area clearfix data-hidden mt30">
			...
			<div class="infor">
				<dl class="info-txt mt4">
					<dt>조회기준일시 :</dt>
					<dd class="f">2020.01.03 18:16:25</dd>
				</dl>
			</div>
		...
		<div id="tabFund1_sub" class="w950">
			<table class="tbl-type-1 ui-set-tbl-type" data-auto-summary="false" border="1" cellspacing="0" summary="펀드명, 계좌번호, 투자원금(원), 평가금액(원), 바로가기 제공" id="tabFund1_sub_table">
				...
				<tr><td class="nodata" colspan="5">보유하신 계좌가 없습니다.</td></tr></tbody>
			</table>
		</div>
		...
		<div id="tabFund3_sub" class="w950">
			...
			<tbody><tr><td class="nodata" colspan="6">보유하신 계좌가 없습니다.</td></tr></tbody></table>
		</div>
		
		<div name="ifrmAcct9" id="ifrmAcct9" class="mt30 ui-set-accessibility">
...
<div class="printnoa">
	...
	<div class="title-area clearfix">
		...
		<span class="infor"><span class=" btn-pack btn-type-2 printnoa ui-btn-pack-a ui-set-btn-pack ui-set-btn-pack-event"><a href="#none" class="" onclick="wbUI.openPopup('/pib/jcc?withyou=PSINQ0013&amp;__ID=c003070');">투자자예탁금이란</a></span></span>
	</div>
	
	<table class="tbl-type-1 tblnocut ui-set-tbl-type" border="1" cellspacing="0" summary="예탁금종류, 예탁기간, 예탁금액 (원), 예약입금펀드, 시작일, 만기일, 상품명, 계좌번호 ����">
...
<div id="tabGold" class="dis-n" style="display: none;"> 
	...
	<div id="PRINT_BLOCK8">  
		<div name="ifrmAcct8" id="ifrmAcct8"></div>	
	</div>
</div>
...
<div id="tabAll" class="dis-n" style="display: none;">	
	...
	<div id="PRINT_BLOCK1"> 
		...
		<div id="tabAll_Gold_sub" class="w950"></div> 
	...
	<div class="btn-area mt20" id="divAllBtnCtrl">
		...
		<span class=" btn-pack btn-type-3 ui-btn-pack-a ui-set-btn-pack ui-set-btn-pack-event"><a class="" href="/pib/jcc?withyou=PSINQ0013&amp;__ID=c004102&amp;fInqCd=4&amp;XSL_FILE_NAME=우리은행_펀드_보유계좌조회_20200103" id="divExcelLink">엑셀저장</a></span>
...
<script type="text/javascript">  
	...
	function openprint(){				
		...
		document.frmPrint.PRINT_GIGAN.value = '2020.01.03 18:16:25';
...
<form name="frmGold" id="frmGold" class="ajax-form ui-set-ajax-form" method="post" action="#none" data-no-ajax="true">
	<input type="hidden" name="ACNO" value="">
	<input type="hidden" name="RCV_ACNO" value=""> 
<input type="hidden" name="transkey_i" id="transkey_i" value="0"><input type="hidden" name="transkey_inputs" id="transkey_inputs" value=""><input type="hidden" name="transkeyUuid" id="transkeyUuid" value="undefined"></form>

<form name="frmFnd" id="frmFnd" class="ajax-form ui-set-ajax-form" method="post" action="/pib/jcc?withyou=PSINQ0013&amp;__ID=c024572" data-no-ajax="true" target="#ifrmAcct9">
<input type="hidden" name="transkey_i" id="transkey_i" value="0"><input type="hidden" name="transkey_inputs" id="transkey_inputs" value=""><input type="hidden" name="transkeyUuid" id="transkeyUuid" value="undefined"></form>
