...
<label for="intnPrd1" class="ml10"><input type="checkbox" id="intnPrd1" name="intnPrd" value="인터넷"/> 인터넷</label>
<label for="intnPrd2" class="ml10"><input type="checkbox" id="intnPrd2" name="intnPrd" value="영업점"/> 영업점</label>
<label for="intnPrd3" class="ml10"><input type="checkbox" id="intnPrd3" name="intnPrd" value="스마트폰"/> 스마트폰</label>
<label for="intnPrd4" class="ml10"><input type="checkbox" id="intnPrd4" name="intnPrd" value="위비뱅크"/> 위비뱅크</label>
<span class="btn-search-pack"><input id="search" type="submit" value="검색" style="color: black;"/></span>
</div>
</fieldset>
...
<div class="product-result-info-area mt30">
    <div class="info-l">
        <span class="fleft"><strong id="TOT_CNT_TXT"></strong>예금상품이 검색되었습니다. </span>
