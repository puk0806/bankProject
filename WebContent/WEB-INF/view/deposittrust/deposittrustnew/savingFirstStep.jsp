...
.pdf-link {
    ...
    font-size: 14px;
    background: url(https://simg.wooribank.com/img/common/etc/file_pdf.gif) no-repeat left 2px;
    padding-left: 27px;
    margin-right: 20px;
    height: 19px;
}
...
.notice-bx {
    ...
    overflow: hidden;
    border: 1px solid #e5e5e5;
    background: #fff url(https://simg.wooribank.com/img/common/etc/img_notice1.gif) no-repeat 30px center;
    margin: 0;
}
...
<div class="box-toggle">
	...
	<span class="box-close"><a href="#none" class="js-display-toggle" data-target="#toggle_Box1" >${saving_feature } 열기</a></span>
</div>
...
<form id="afrm" name="afrm" class="ajax-form" method="post" action="/bankJSPProject/deposittrust/deposittrustnew/savingSecondStep.do?" data-no-ajax="true">
...
<div class="agree_group">
			...
			<div id="AGR_" class="agree-box mb10" tabindex="0">
				...
				<div class="agree-txt">
					<h4>[적금] 적금거래 기본약관</h4>
					<div><p>이 적금거래 기본약관(이하 "약관"이라 한다)은 우리은행(이하 "은행"이라 한다)과 거래처(또는 예금주)가 서로 믿음을 바탕으로 예금거래를 빠르고 틀림없이 처리하는 한편, 서로의 이해관계를 합리적으로 조정하기 위하여 기본적이고 일반적인 사항을 정한 것이다. 은행은 이 약관을 영업점에 놓아두고, 거래처는 영업시간 중 언제든지 이 약관을 볼 수 있고 또한 그 교부를 청구할 수 있다.</p>
<p><br></p><strong>제 1 조 적용범위 </strong>
<p>이 약관은 입출금이 자유로운 적금, 거치식 적금 및 적립식 적금 거래에 적용한다.</p>
<p><br></p>
...
<p style="line-height: 160%;">&#9312; 거치식적금(이하 "이 적금"이라 한다)이란 예치기간을 정하고 거래를 시작할 때 맡긴 돈을 만기에 찾는 예금을 말한다.<br>
 &#9313; 이 약관에서 정하지 아니한 사항은 적금거래 기본약관의 규정을 적용한다.<br> &#9314; 복리 자유적립식 정기예금과 양도성 예금증서 및 표지어음의 거래에는 이 약관을 적용한다.</p>
<p style="line-height: 160%;"><br>
 <strong>제 2 조 지급시기</strong></p>
<p style="line-height: 160%;">이 적금은 약정한 만기일 이후 거래처가 청구할 때 지급한다. 다만, 거래처가 부득이한 사정으로 청구할 때는 만기 전이라도 지급할 수 있다.</p>
...
<p style="line-height: 160%;"><br>
 <strong>제 9 조 준용</strong><br> 이 약관에서 정하지 아니한 사항은 예금거래 기본약관, 관련 예금약관, 신탁약관, 여신거래 기본약관, 개별 상품약관 및 은행 내규를 준용합니다.</p></div>
			...
			<div id="AGR_" class="agree-box mb20" tabindex="0">
				...
				<div class="agree-txt">
					<h4>상품약관_${name}</h4>
					<div><p><strong>제1조 약관의 적용<br></strong>${saving_feature}(이하 &lsquo;이 적금&rsquo;이라 합니다)의 거래에는 이 특약을 적용하며, 이 특약에서 정하지 않은 사항은&nbsp; 「적금거래 기본약관」, 「거치식적금약관」, 「전자금융거래 기본약관」 및 「전자뱅킹서비스 이용약관」을 적용합니다.</p>
<p><br></p>
<p><strong>제2조 적금과목<br></strong>이 적금의 과목은 정기예금으로 합니다.</p>
<p><br></p>
<p><strong>제3조 가입대상<br></strong>이 적금의 가입대상은 실명의 개인 및 개인사업자입니다. </p>
<p><br></p>
<p><strong>제4조 가입금액<br></strong>이 적금의 가입금액은 제한이 없습니다.</p>
<p><br></p>
<p><strong>제5조 가입방법<br></strong>이 적금은 인터넷뱅킹과 스마트뱅킹 등 전자금융 채널로 가입할 수 있습니다.</p>
<p><br></p>
<p><strong>제6조 모집기간<br></strong>&#9312; 이 적금은 회차별로 정해진 모집기간 동안 판매합니다.<br>&#9313; 회차별 모집기간은 영업점 또는 인터넷 홈페이지에 고시합니다.</p>
<p><br></p>
<p><strong>제7조 계약기간<br></strong>이 적금의 계약기간은 3개월, 6개월, 1년 중에서 모집 회차별로 은행에서 정하며, 모집기간 시작일에 영업점 또는 인터넷 홈페이지에 고시합니다. </p>
<p><br></p>
<p><strong>제8조 이자지급<br></strong>이 적금의 이자는 만기에 지급합니다.</p>
<p><br></p>
<p><strong>제9조 적용이율<br></strong>이 적금의 이율은 회차별 모집기간 시작일에 영업점 또는 인터넷 홈페이지에 고시한 모집금액에 따른 차등이율을 적용합니다.</p>
<p><br></p>
<p><strong>제10조 우대조건<br></strong>이 적금을 iTouch우리통장, 우리꿈통장, 위비모바일통장, WON통장에 연결하여 가입하는 경우 제11조의 우대이율을 제공합니다.</p>
<p><br></p>
<p><strong>제11조 우대이율<br></strong>제10조의 우대조건을 충족하는 경우 적용이율에 연 0.1%p의 우대이율을 더하여 이자를 계산합니다.</p>
<p><br></p>
<p><strong>제12조 중도해지이율<br></strong>이 적금은 중도해지 시 신규일 당시 영업점 및 인터넷 홈페이지에 고시한 중도해지이율을 적용합니다.</p>
<p><br></p>
<p><strong>제13조 만기후이율<br></strong>이 적금은 만기 후 해지 시 만기일 당시 영업점 및 인터넷 홈페이지에 고시한 일반정기예금 만기후이율을 적용합니다.</p>
...
<p><br></p></div>
			...
			<div id="AGRD_" class="clearfix ageeDownload mb30">
				<dl>
					...
					<dd>
							...
							<a class="pdf-link"  href="pot/mall/comm/download.jsp?PLM_BIZ_DSCD=00&PLM_ANX_SAVE_FILE_NM=PLM_P00XXXXXXX_A0101_20180503000100000990.pdf&PLM_ATFL_NM=예금거래기본약관2016.12.30.pdf">[적금] 적금거래 기본약관</a>
						
							
							<a class="pdf-link"  href="pot/mall/comm/download.jsp?PLM_BIZ_DSCD=00&PLM_ANX_SAVE_FILE_NM=PLM_P00XXXXXXX_A0102_20180503000100000984.pdf&PLM_ATFL_NM=거치식예금약관[1332406082079].pdf">[적금] 거치식 적금약관</a>
							...
							<a class="pdf-link"  href="pot/mall/comm/download.jsp?PLM_BIZ_DSCD=01&PLM_ANX_SAVE_FILE_NM=PLM_P010002355_DF003_20190813202623000158.pdf&PLM_ATFL_NM=모이면금리가올라가는예금_약관.pdf">상품약관_${saving_feature }</a>
		...
		<div class="agree-box mtm10 mb20" tabindex="0">
            ...
            <dl>
                <dt class="bg-n pl0">적금별 신규가능금액</dt>
                <dd class="bg-n pl0">금일 해지한 적금의 범위내에서는 가입이 가능합니다.</dd>
            </dl>
            <table class="tbl-type-1 ml10" border="1" cellspacing="0" summary="해지적금, 재예치적금, 신규 가능한 금액, 비고">
                <caption>예금별 적금가능금액정보</caption>
                <colgroup>
                    <col width="15%" />
                    <col width="15%" />
                    <col width="30%" />
                ...
                <thead>
                    <tr>
                        <th scope="col">해지적금</th>
                        <th scope="col">재예치적금</th>
                ...
                <tbody>
                    <tr>
                        ...
                        <td rowspan="5" class="txt-l">
                            <ol>
                                <li class="font-13">1. 적금 재예치는 금일 해지된 적금의 해지금액 범위내에서 가능합니다. (환매기간이 필요한 경우 계좌입금일까지 가능)</li>
                            </ol>
                        </td>
                    </tr>
                    <tr>
                        <td>거치식<br />(자유적금 포함)</td>
                        <td>적립식</td>
                        <td class="dtd-r">해지적금의 월환산 금액범위내</td>
                    </tr>
                    <tr>
                        <td>적립식</td>
                        <td>거치식</td>
