...
<form  id="loginform" name="loginform" action="/bankJSPProject/auth/login.auth" method="post" >
			...
			<div class="ID_Login">
				<dl>
					...
					<dd class="ID_Input_Cont">
						<ul class="Input_Cont">
							<li>
								<input type="text" id="user_id" name = "user_id" value="miji12" class="IDLogin_text_field" placeholder="" datatype="NA" autocomplete="off" colname="아이디"  maxlength="10">
