...
<form id="frm" name="frm" method="post" action="/bankJSPProject/product/s_itemUpdate.admin?item_no=${s_item.s_item_no}" class="ajax-form" data-no-ajax="true" data-target="#RECV_NAME">
...
<tr class='input-area-smp'>
	...
	<td colspan='3'>
		<input name="saving_item_name" value="${s_item.saving_item_name}" > <br>
</td></tr>
<tr class='input-area-smp'>
	<th scope='row'>
	...
	<td colspan='3'>
		<input name="savings_item_length" value="${s_item.savings_item_length}" > <br>
</td></tr>
...
<tr class='input-area-smp'>
	<th scope='row'><label for='ENCY_WDR_ACT_PWNO'>금리</label></th>
		<td colspan='3'><div id="Tk_ENCY_WDR_ACT_PWNO" style="display : inline-table; vertical-align: middle;">
			<input name="savng_interest" value="${s_item.savng_interest}" > <br>
		</td>
		</tr></tbody></table>
...
<td colspan='3'>
<input type="radio" name="i_type_rfs_no" value="ITR1001">정기정액적립식 <input type="radio" name="i_type_rfs_no" value="ITR1002">자유적립식<br>
</td>
</tr>
<tr><th scope='row'>가입최대금액</th>
<td colspan='3'>
<input name="saving_item_maxmoney" value="${s_item.saving_item_maxmoney}" > <br>
</td>
</tr>
<tr><th scope='row'><label for='ITPY_MECD'>우대금리여부</label></th>
<td colspan='3'>
<input name="treat_interest_check" value="${s_item.treat_interest_check}" > <br>
</td>
</tr>
<input type='hidden' name='ITPY_CYCD' value='00'/>
<tr><th scope='row'><label for='ITPY_MECD'>이자지급방법</label></th>
<td colspan='3'>
<input name="interest_pay_method" value="${s_item.interest_pay_method}" > <br>
</td>
</tr>
...
<td colspan='3'>
<input name="end_terminate_method" value="${s_item.end_terminate_method}" > <br>
</td></tr>
...
<input name="customer_protect_content" value="${s_item.customer_protect_content}" > <br>
</td></tr>
...
<input type="radio" name="ps_type_no" value="PS1000" >판매중 <input type="radio" name="ps_type_no" value="PS1001">판매중단 <br>
</td></tr>
...
<td colspan='3'>
<input name="outlines" value="${s_item.outlines}" > <br>
</td></tr>
