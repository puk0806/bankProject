...
<div class="product-result-info-area mt30">
    <div class="info-l">
        <span class="fleft"><strong id="TOT_CNT_TXT">'${page.getTotal() }'</strong>개의 골드상품이 검색되었습니다. </span>
   ...
   <div class="product-list">
	<div class="product clearfix">
			            <div class="prd-info pr70 w49p">		                
			                <dl>
			                    <dt class="name">
			                    <a href="/bankJSPProject/product/g_itemDetail.admin?item_no=${dto.g_item_no}" >${dto.g_item_name}</a></dt>
								<dd class="tit">
					            	<em class="mr10">${dto.outlines }</em>
				                </dd>
			                    <dd class="dsc" title="">${dto.feature } <br>
								</dd>
			                    <dd class="foot">
			                        <ul> 
			            ...
			            <div class="prd-btn">
							...
							<c:forEach items="${fn:split(sign_method1, ',') }" var="sign_method">
	                            ...
	                            <span class=" btn-pack btn-type-3 ui-btn-pack-a ui-set-btn-pack ui-set-btn-pack-event"><a href="/bankJSPProject/product/g_itemDetail.admin?item_no=${dto.g_item_no}" onclick="goDetails(1 , 'P010002353' );" class="">상세보기</a></span>
	                        </div>
			                <div class="prd-ico-area">
				                <a href="#none" onclick="wbFavorPrdBox.init('1').put('P010002353', '');" class="btn-put-ico-1 js-display-on-off" data-show=".put-tooltip-1" data-ui-showonhover="true"><span class="hidden">${dto.g_item_name}</span>관심상품등록<span class="tooltip-pack-2 put-tooltip-1">관심상품등록</span></a>
				                <a href="#none" onclick="wbCmpPrdBox.init('Dep').put('cmpFinPrdCookieid', 'P010002353', 'WON 적금');" class="btn-compare-ico-1 js-display-on-off" data-show=".compare-tooltip-1" data-ui-showonhover="true"><span class="hidden">${dto.g_item_name}</span>비교함담기<span class="tooltip-pack-2 compare-tooltip-1">비교함담기</span></a>
			                </div>
			            </div>
			        </div>
					</div>
