    ...
    <div class="product-list image-type detail-type">
        <div class="product clearfix">
            <div class="prd-info">
                ...
                <dl>
                    <dt class="name">${dto.saving_item_name }
                    ...
                    <dd class="subject">
                        <div>
                                    ...
                                    <dl><dt>가입기간</dt><dd><p> ${dto.savings_item_length }<br></p></dd></dl>
                                    
                                    <dl><dt>가입금액</dt><dd>${dto.saving_item_maxmoney }원 이상 가입가능</dd></dl>
...
<div class="product-functab-cont clearfix">
    <div id="tab-cont-1" class="tab-cont-1 dis-n clearfix ui-set-accessibility" style="display: block;">
	            ...
	            <dl class="po-detail-info">
	            <dt>특징</dt><dd><p>${dto.saving_feature }<br></p></dd>
	            </dl>
			    
			    
			    <dl class="po-detail-info">
	            <dt>예금자보호</dt><dd>${dto.customer_protect_content }</dd>
	            </dl>
	            ...
	            <dl class="po-detail-info">
	            <dt>가입금액</dt>
	            <dd><p><span style="font-size: 11pt;">${dto.saving_item_maxmoney }</span><br></p></dd>
	            </dl>
	            
	            
	            
		            <dl class="po-detail-info">
		            <dt>가입기간</dt><dd><p><span style="font-size: 11pt;">${dto.savings_item_length }</span><br></p></dd>
		            </dl>
			            ...
			            <dl class="po-detail-info">
			            <dt>기본금리</dt><dd><p><span style="font-size: 11pt;">${dto.savng_interest }</span></p>
<p><span style="font-size: 11pt;">▷ 가입기간 12개월 : ${dto.savng_interest } %,&nbsp;24개월 : 연 ${dto.savng_interest*1.2 }%&nbsp; ('20.1.2 기준, 세금 납부 전)</span><br></p></dd>
			            </dl>
...
<p><span style="font-size: 11pt;">&nbsp;&nbsp;&nbsp;${dto.treat_interest_check }</span></p>
</dd>
			            </dl>
			            ...
			            <dl class="po-detail-info">
			            <dt>만기 후 이율</dt><dd>만기일 당시 고시한 일반정기적금 만기 후 이율 적용</dd>
			            </dl>
...
<table class="tbl-type-1 ui-set-tbl-type" border="0" cellspacing="0" summary="구분, 기간 및 금액, 금리(연), 비고, 약정이율, 만기후이율, 중도해지이율 ����">
	...
	<td class="dtd-r">${dto.savng_interest }</td>
				                ...
				                <!-- iTouch 우리예금 비고-하드코딩 제거 -->
									...
									<td rowspan="2" class="txt-l">우대조건 충족시 최대 연 ${dto.savng_interest +0.4}% 우대</td>
	...
	<td class="dtd-r">${dto.savng_interest *1.2 }</td>
	...
	<td class="dtd-r">▶</td>
									...
									<td rowspan="1" class="txt-l">만기일 당시 고시한 일반정기적금 만기 후 이율 적용</td>
...
※ 판매한도 소진시 별도 공지 없이 판매가 중단됩니다</dd>
	           	 ...
	           	 <dl class="po-detail-info">
				 <dt>추가내용</dt>  		
	           	 <dd><p><span style="font-size: 11pt;">▷ [가입하기] 통해 적금신규가입 정보입력 시 고객별 거래기간 확인 가능합니다. </span><br></p>
<p><br></p></dd>
	           	 </dl>
            ...
            <dd class="no download">
               <a class="pdf" href="pot/mall/comm/download.jsp?PLM_BIZ_DSCD=00&amp;PLM_ANX_SAVE_FILE_NM=PLM_P00XXXXXXX_A0101_20180503000100000990.pdf&amp;PLM_ATFL_NM=예금거래기본약관2016.12.30.pdf">[적금] 적금거래 기본약관</a><a class="pdf" href="pot/mall/comm/download.jsp?PLM_BIZ_DSCD=00&amp;PLM_ANX_SAVE_FILE_NM=PLM_P00XXXXXXX_A0102_20180503000100000984.pdf&amp;PLM_ATFL_NM=거치식예금약관[1332406082079].pdf">[적금] 거치식 적금약관</a><a class="pdf" href="pot/mall/comm/download.jsp?PLM_BIZ_DSCD=01&amp;PLM_ANX_SAVE_FILE_NM=PLM_P010002380_DF003_20191224170803000004.pdf&amp;PLM_ATFL_NM=[특약] 우리고객님 고맙습니다 정기예금.pdf">[특약] 우리고객님 고맙습니다 정기적금</a><a class="pdf" href="pot/mall/comm/download.jsp?PLM_BIZ_DSCD=01&amp;PLM_ANX_SAVE_FILE_NM=PLM_P010002380_DA001_20191224170747000283.pdf&amp;PLM_ATFL_NM=[상품설명서] 우리고객님 고맙습니다 정기예금.pdf">[상품설명서] 우리고객님 고맙습니다 정기적금</a>               
            </dd>
            </dl>
