...
<form id="frm" name="frm" method="post" action="/bankJSPProject/product/g_itemRegister.admin" class="ajax-form" data-no-ajax="true" data-target="#RECV_NAME">
...
<tr class='input-area-smp'>
	...
	<td colspan='3'>
		<input name="g_item_name" value="우리 골드 투자 2" > <br>
</td></tr>
<tr class='input-area-smp'>
	<th scope='row'>
	...
	<td colspan='3'>
		<input name="sign_period" value="12" > <br>
</td></tr>
...
<td colspan='3'>
<input name="gold_item_transunit" value="0.1" > <br>
</td>
</tr>
<tr><th scope='row'>우대환율여부</th>
<td colspan='3'>
<input type="radio" name="treat_transrate_check" value="적용" checked="checked">적용 <input type="radio" name="treat_transrate_check" value="미적용"> 미적용<br>
</td>
</tr>
...
<input name="gold_price" value="1" > <br>
</td></tr>
<tr><th scope='row'>예치방식</th><td colspan='3'>
<input type="radio" name="r_method_type_no" value="RM1000" checked="checked">입출식 <input type="radio" name="r_method_type_no" value="RM1001"> 거치식<br>
</td></tr>
</tbody>
</table>
...
<td colspan='3'>
<input name="feature" value="실물거래 없이 자유롭게 금 거래(입출금)를 할 수 있습니다. (소액거래 가능)" > <br>
</td></tr>
</tbody>
</table>
