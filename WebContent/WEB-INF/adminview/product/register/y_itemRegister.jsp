...
<form action="/bankJSPProject/product/y_itemRegister.admin" method="post">
	...
	세제혜택 :
		...
		<br>
	상품명 : <input name="yegeum_item_name" value="WON예금2" > <br>
	금리 : <input name="yegeum_interest" value="2.1" > <br>
	...
	예금자보호내용 :  : <input name="yegeumer_protect_content" value="없음" > <br>
	...
	수수료 면제총 횟수 : <input name="commission_total_count" value="5" > <br>
