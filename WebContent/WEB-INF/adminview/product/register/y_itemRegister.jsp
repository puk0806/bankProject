...
<form id="frm" name="frm" method="post" action="/bankJSPProject/product/y_itemRegister.admin" class="ajax-form" data-no-ajax="true" data-target="#RECV_NAME">
...
<tr class='input-area-smp'>
	...
	<td colspan='3'>
		<input name="yegeum_item_name" value="WON예금2" > <br>
</td></tr>
<tr class='input-area-smp'>
	<th scope='row'>
	...
	<td colspan='3'>
		<input name="yegeum_item_length" value="1~24" > <br>
</td></tr>
...
<tr class='input-area-smp'>
	<th scope='row'><label for='ENCY_WDR_ACT_PWNO'>금리</label></th>
		<td colspan='3'><div id="Tk_ENCY_WDR_ACT_PWNO" style="display : inline-table; vertical-align: middle;">
			<input name="yegeum_interest" value="2.1" > <br>
		</td>
		</tr></tbody></table>
...
<td colspan='3'>
<input name="yegeum_item_limitmoney" value="210000000" > <br>
</td>
</tr>
<tr><th scope='row'><label for='ITPY_MECD'>우대금리여부</label></th>
<td colspan='3'>
<input name="treat_interest_check_exp" value="WON통장, 우리꿈통장을 기본계좌로 하고 이 적금을 연결가입하는 경우 0.2%" > <br>
</td>
</tr>
<input type='hidden' name='ITPY_CYCD' value='00'/>
<tr><th scope='row'><label for='ITPY_MECD'>이자지급방법</label></th>
<td colspan='3'>
<input name="interest_payment_method" value="만기일시지급식" > <br>
</td>
</tr>
...
<td colspan='3'>
<input type="radio" name="yegeumer_protect_check" value="적용" checked="checked">적용 <input type="radio" name="yegeumer_protect_check" value="미적용"> 미적용<br>
</td></tr>

<tr><th scope='row'>예금자보호내용</th><td colspan='3'>
<input name="yegeumer_protect_content" value="없음" > <br>
</td></tr>
...
<input name="commission_total_count" value="5" > <br>
</td></tr>
<tr><th scope='row'>사용가능채널</th><td colspan='3'>
<input type="checkbox" name="available_chan" value="인터넷뱅킹" checked="checked"> 인터넷뱅킹 <input type="checkbox" name="available_chan" value="ATM" >ATM <input type="checkbox" name="available_chan" value="스마트폰" > 스마트폰 <br>
</td></tr>
</tbody>
</table>
...
<td colspan='3'>
<input name="outlines" value="가입기간도 금액도 자유롭게 만기해지시 금리는 2배" > <br>
</td></tr>
<tr><th scope='row'>특징</th>
<td colspan='3'>
<input name="yegeum_feature" value="ss만기를 선택하여 자유롭게 가입이 가능 해당기간별 높은금리 제공" > <br>
</td></tr>
</tbody>
</table>
