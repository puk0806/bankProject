...
<div id="tabDep_sub_top1" class="title-area clearfix mt30 data-hidden">
	...
	<tbody>
		<tr>
			...
			<td>${dto.account_trans_money }</td>
			<td class="txt-r pr20">
				<strong class="bluefont">${dto.account_trans_date }</strong>
			</td>
			
			<td> ${dto.account_current_money } <br>
			</td>
			</tr>
