...
public class FundItemDTO {
	private String fu_item_no;
	private String st_type_no;
	private String r_rate_no;
	private String fi_type_no;
	private String fund_item_comment;
	private int fund_item_profitrate;
	...
	public int getFund_item_profitrate() {
		return fund_item_profitrate;
	}
	public void setFund_item_profitrate(int fund_item_profitrate) {
