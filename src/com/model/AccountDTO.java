...
public class AccountDTO {
   ...
   public AccountDTO(String account_no, String u_info_no, String l_bank_no, String a_type_no,
         String a_state_no, String currency_no, String account_number, Date account_create_date,
         String account_yegeum_name, int account_limit, int account_pwd, String account_nick) {
      super();
